...
TEST(Hsv, clamp) {
    {
        ...
        ASSERT_COLORS_NEAR(c2, Hsv<float>(0.0, 0.3, 0.9), FLOAT_TOL);
    }
...
TEST(Hsv, normalize) {
    {
        ...
        ASSERT_COLORS_NEAR(c1, Hsv<float>(0.8, 0.5, 1.0), FLOAT_TOL);
        ASSERT_COLORS_NEAR(c2, Hsv<float>(0.35, 0.0, 1.0), FLOAT_TOL);
        ASSERT_COLORS_NEAR(c3, c3.normalize(), FLOAT_TOL);
    }

    {
        auto c1 = Hsv<uint8_t>(100, 255, 0);
        auto c2 = Hsv<uint8_t>(0, 0, 0);

        ASSERT_COLORS_EQ(c1, c1.normalize());
        ASSERT_COLORS_EQ(c2, c2.normalize());
    }
}
...
TEST(Hsv, inverse) {
    {
        ...
        ASSERT_COLORS_NEAR(c1.inverse(), Hsv<float>(0.3, 0.8, 0.5), FLOAT_TOL);
        ASSERT_COLORS_NEAR(c2.inverse(), Hsv<float>(0.0, 0.5, 0.5), FLOAT_TOL);
        ASSERT_COLORS_NEAR(c3.inverse(), Hsv<float>(0.5, 0.75, 0.0), FLOAT_TOL);
    }

    {
        ...
        ASSERT_COLORS_EQ(c1.inverse(), Hsv<uint8_t>(255, 5, 205));
        ASSERT_COLORS_EQ(c2.inverse(), Hsv<uint8_t>(128, 0, 125));
        ASSERT_COLORS_EQ(c3.inverse(), Hsv<uint8_t>(72, 55, 155));
    }
}
...
TEST(Hsv, lerp) {
    {
        ...
        ASSERT_COLORS_NEAR(result1, Hsv<float>(0.0, 0.35, 0.55), FLOAT_TOL);
        ASSERT_COLORS_NEAR(result2, Hsv<float>(0.7, 0.45, 0.9), FLOAT_TOL);
    }

    {
        ...
        ASSERT_COLORS_EQ(c1.lerp(c2, 0.4), Hsv<uint8_t>(140, 160, 193));
        ASSERT_COLORS_EQ(c2.lerp(c1, 0.6), Hsv<uint8_t>(140, 160, 193));
    }

    {
        ...
        ASSERT_COLORS_EQ(c1.lerp(c2, 0.5), Hsv<uint8_t>(0, 187, 225));
        ASSERT_COLORS_EQ(c2.lerp(c1, 0.5), Hsv<uint8_t>(0, 187, 225));
        ASSERT_COLORS_EQ(c1.lerp(c2, 0.75), Hsv<uint8_t>(230, 218, 237));
        ASSERT_COLORS_EQ(c2.lerp(c1, 0.25), Hsv<uint8_t>(230, 218, 237));
        ASSERT_COLORS_EQ(c1.lerp(c2, 0.25), Hsv<uint8_t>(25, 156, 212));
        ASSERT_COLORS_EQ(c2.lerp(c1, 0.75), Hsv<uint8_t>(25, 156, 212));
        ASSERT_COLORS_EQ(c1.lerp(c2, 0.0), Hsv<uint8_t>(50, 125, 200));
        ASSERT_COLORS_EQ(c2.lerp(c1, 1.0), Hsv<uint8_t>(50, 125, 200));
    }

    {
        ...
        ASSERT_COLORS_EQ(c1.lerp(c2, 0.5), Hsv<uint8_t>(0, 150, 150));
    }

    {
        ...
        ASSERT_COLORS_NEAR(result1, Hsv<float>(0.5, 0.35, 0.55), FLOAT_TOL);
        ASSERT_COLORS_NEAR(result2, Hsv<float>(0.7, 0.45, 0.9), FLOAT_TOL);
    }
}
...
TEST(Hsv, scale) {
    {
        ...
        ASSERT_COLORS_NEAR(
                c1.scale(0.5), Hsv<float>(0.45, 0.25, 0.0), FLOAT_TOL);
        ASSERT_COLORS_NEAR(
                c2.scale(0.1), Hsv<float>(-0.05, 0.08, 0.01), FLOAT_TOL);
    }

    {
        auto c1 = Hsv<uint16_t>(30000, 10000, 60000);

        ASSERT_COLORS_EQ(c1.scale(0.1), Hsv<uint16_t>(3000, 1000, 6000));
    }
}
...
TEST(Hsv, broadcast) {
    {
        ...
        ASSERT_COLORS_NEAR(c1, Hsv<float>(0.66, 0.66, 0.66), FLOAT_TOL);
        ASSERT_COLORS_EQ(c2, Hsv<uint8_t>(173, 173, 173));
        ASSERT_COLORS_EQ(c3, Hsv<unsigned int>(0, 0, 0));
    }
}
...
TEST(Hsv, swap) {
    ...
    ASSERT_COLORS_NEAR(c1, Hsv<float>(0.5, 0.6, 0.7), FLOAT_TOL);
    ASSERT_COLORS_NEAR(c2, Hsv<float>(0.2, 0.3, 0.4), FLOAT_TOL);
}
